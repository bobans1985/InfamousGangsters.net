                        ...
                        <div class="main curve2px">
                            ...
                            <div style="padding: 5px; margin: auto; text-align: center; color: #fefefe;">
                                <div style="margin: auto; padding-top: 16px; padding-bottom: 6px; text-align: left;">
                                    ...
                                    $usersonlineresult = mysql_query("SELECT username,rankid,crewid,money FROM users WHERE activity >= '$timetwo' AND crewid = '$mycrewid' ORDER BY ID ASC");
                                    ...
                                    while($usersonline = mysql_fetch_array($usersonlineresult)) {
                                        ...
                                        echo"<a href=viewprofile.php?username=$onlineuser><font color=silver> $onlineuser -</a>";
                                    }?>
                                            ...
                                            <tbody><tr><td style="text-align: left; padding: 3px; padding-right: 2px;">
                                                ...
                                                <td style="padding: 5px;" align="right">
                                                    <div style="padding-right: 4px;font-size:10px;">
                                                        <span style="color: #fefefe;"><b style="color: #FFC753;"><? echo $usersonlinecount; ?></b>&nbsp;Crew Users&nbsp;Online</span>
                                                    </div>
                                                </td>
                                            </tr>
                                            </tbody>
