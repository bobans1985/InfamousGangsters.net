                        ...
                        <div class="main curve2px">
                            ...
                            <div style="padding: 5px; margin: auto; text-align: center; color: #fefefe;">
                                <div style="margin: auto; padding-top: 16px; padding-bottom: 6px; text-align: center;">
                                    ...
                                    $getthemessagee = mysql_query("SELECT * FROM gametimes WHERE game = 'notif'");
                                    $getthemessage = mysql_fetch_array($getthemessagee);
                                    $checkmessagee = $getthemessage['message'];
                                    $checkmessage = str_replace("<br />", "\n", $checkmessagee);
                                    ...
                                    if($_POST['do']){
                                        ...
                                        while($selectallarray = mysql_fetch_array($selectallsql)){
                                            ...
                                            mysql_query("UPDATE users SET notify = '1',notification = '$themessage' WHERE username = '$sendtoall'");
                                        }echo "<font color=white size=1 face=verdana>Done.</font>";
                                    }
                                    if($_POST['dont']){
                                        mysql_query("UPDATE users SET bignotif = '0'");
                                        mysql_query("UPDATE gametimes SET time = '0' WHERE game = 'notif'");
                                        echo "<font color=white size=1 face=verdana>Done.</font>";
                                    }
                                    ?>
                                    <center>
                                        <form action="" method="post">
                                            <textarea name="message" cols="60" rows="20" class="textbox inline_form" id ="message"><?echo$checkmessage?></textarea><br/>
                                            <br/><input type="submit" value="Post It" class="textarea curve3px" name="do">
                                            <input type="submit" value="Remove It" class="textarea curve3px" name="dont">
                                        </form>
                                    </center>
                                </div>
                            </div>
