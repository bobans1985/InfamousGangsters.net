<?
$thehdos = mysql_query("SELECT * FROM senior ORDER BY time");
...
$postinfo = "[b]Username[/b]: $hdoname [b]Status[/b]: $hdostatus [b]Type[/b]: Senior [b]Promoted by[/b]: $promotedby [b]When[/b]: $promotedtime";
