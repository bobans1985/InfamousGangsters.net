...
<table cellspacing="0" class="resize" id="block">
    <tr>
        ...
        <td valign="top" class="main">
            ...
            if($_POST['rate']){
                $rating = $_POST['rating'];
                $doneitalready = mysql_num_rows(mysql_query("SELECT * FROM entertainrate WHERE username = '$usernameone' AND topicid = '$topicid'"));
                if($doneitalready > 0){ $showoutcome++; $outcome = "You have already rated this topic!"; }
                else{
                    mysql_query("INSERT INTO `entertainrate` (username,topicid,rating) VALUES ('$usernameone','$topicid','$rating')");
            ...
            if(isset($_POST['dopost'])) {
                ...
                elseif($topiccheck == '0'){$showoutcome++; $outcome = '<font color=red face=verdana size=1><b>No such topic!</b></font><META HTTP-EQUIV="Refresh" CONTENT="2; URL=eforum.php">';}
                else{
                    $posttits++;
...
VALUES ('$gangsterusername','$topicid','$userip','$post_time','e','$newpost','$playerrank','$reply_user')");
                    }else{
                        mysql_query("INSERT INTO forumposts(username,topicid,ip,time,type,post,rankid)
VALUES ('$gangsterusername','$topicid','$userip','$post_time','e','$newpost','$playerrank')");
                    }
            ...
            if(($topiccreator == $gangsterusername)||($rankid == '100')||($rankid == '75')||($rankid == '50')||($hdo > '0')){
                if(isset($_GET['lock'])) { $showoutcome++; $outcome = '<font color=white face=verdana size=1>Topic locked</font>';mysql_query("UPDATE forumtopics SET locked = 'yes' WHERE topicid = '$topicid' AND type = 'e'");}
            }

            if(($rankid == '100')||($rankid == '75')||($rankid == '50')||($hdo > '0')){
                if(isset($_GET['unlock'])) {$showoutcome++; $outcome = '<font color=white face=verdana size=1>Topic Unlocked</font>';mysql_query("UPDATE forumtopics SET locked = 'no' WHERE topicid = '$topicid' AND type = 'e'");}
            }
            ...
            if($exists == '0'){$showoutcome++; $outcome = '<font color=red face=verdana size=1><b>No such topic!</b></font><META HTTP-EQUIV="Refresh" CONTENT="2; URL=eforum.php">';}
            ...
            <script>
                function ajaxFunctionhis(){
                    ...
                    ajaxRequest.open("GET", "newpost3.php?posts=" + strhehe, true);
            ...
            <? $checkratings = mysql_num_rows(mysql_query("SELECT * FROM entertainrate WHERE topicid = '$topicid'")); ?>
                            ...
                            <div style="display: table; width: 100%; padding: 9px; padding-top: 5px; padding-bottom: 5px;">
                                ...
                                <div style="display: table-cell; text-align: right;">
                                    ...
                                    if(($topiccreator == $gangsterusername)||($rankid >= '25')||($hdoperson > '0')){
                                        ...
                                        echo"<a href=eviewtopic.php?topicid=$topicid&lock=1 style=color:$cu;><b> Lock </b></a>";}
                                    if(($rankid >= '25')||($ahdo > '0')){
                                        if($toplocked == 'yes'){$cu = 'white';}
                                        else{$cu='white';}
                                        echo"<span class=\"miniSep\"> - </span><a href=eviewtopic.php?topicid=$topicid&unlock=1 style=color:$cu;><b>Unlock </b></a>";
                                    }?>
                                </div>
            ...
            <div id=editee style="display:none;" name=edit>
                <div style="margin: auto; max-width: 413px;">
                    <form action="eviewtopic.php?topicid=<?echo$topicid;?>" method="post" name="smileys" style="text-align: center;">
            ...
            ?>
                <form action = "eviewtopic.php?topicid=<?echo$topicid;?>" method = "post" style="padding: 7px; text-align: center;">
            ...
            <?php
            $getposts = mysql_query("SELECT username,rankid,id,post,time,reply FROM forumposts WHERE topicid = '$topicid' AND type = 'e' ORDER BY id DESC LIMIT $selectfrom,$selectto ");
            ...
            <table class="menuTable curve10px" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    ...
                    <input type ="submit" value="NORMAL" class=\'textarea inline_form curve3px\' name="undo">';
                            ...
                            <div style="margin: auto; max-width: 413px;">
                                <form action="eviewtopic.php?topicid=<?echo$topicid;?>" method="post" name="smiley" style="text-align:center;">
