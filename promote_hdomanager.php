        ...
        <td valign="top" class="main">
            ...
            if(isset($_POST['dodemote'])){
                ...
                if($rows < '1'){$showoutcome++; $outcome = "<font color=white face=verdana size=1>No such user!</font>";}
                    ...
                    $showoutcome++;
                    $outcome = "<font color=white face=verdana size=1>User <b>$name</b> is no longer a HDO Manager!</font>";
                ...
                if(isset($_POST['demote'])) {
                    ...
                    elseif($status != 'Alive'){$showoutcome++; $outcome = "<font color=white face=verdana size=1>That user is dead!</font>";}
                        ...
                        mysql_query("UPDATE users SET rankid = '75' WHERE username = '$name'");
                        $showoutcome++; $outcome = "<font color=white face=verdana size=1>User <b>$name</b> is now a HDO Manager! <b>YOU</b> now take responsibility for their actions!</font>";
                    }}}
            ?>
