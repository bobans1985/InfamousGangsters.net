...
$tyn = rand(0,5);
if($tyn == '3'){
    $deletetopicssql = mysql_query("SELECT topicid FROM forumtopics WHERE id = '1' AND type = 'd' ORDER BY time DESC LIMIT 27,31");
                            ...
                            <div style="padding: 5px; margin: auto; text-align: center; color: #fefefe;">
                                <div style="margin: auto; padding-top: 16px; padding-bottom: 6px; text-align: center;">
                                    ...
                                    if($forumtopic){
                                        ...
                                        $topicchecksql = mysql_query("SELECT * FROM forumtopics WHERE title = '$forumtopic' AND type = 'd'");
                                        $topiccheck = mysql_num_rows($topicchecksql);

                                        $topicchecksqltwo = mysql_query("SELECT * FROM forumtopics WHERE creator = '$gangsterusername' AND id = '1' AND type = 'd'");
                                    ...
                                    if(isset($_POST['do'])) {
                                        ...
                                        elseif($topicchecktwo > '10'){ echo'<font color="white" face="verdana" size="1">You cannot have more than 10 topics on the forum at one time!</font>';}
											...
											VALUES ('$gangsterusername','1','$time','d','$forumtopic','$forumtopicinfo','$rank','$topic_dte')");
                                    ...
                                    if(isset($_POST['clear'])) {
                                        if($rank != '100'){echo"<font color=white face=verdana size=1>Nice try</font>";}
                                            ...
                                            $deleteall = mysql_query("SELECT * FROM forumtopics WHERE type= 'd' AND id= '1'");
                                            while($deletealla = mysql_fetch_array($deleteall)){
                                                $deleteid = $deletealla['topicid'];
                                                mysql_query("DELETE FROM forumtopics WHERE type = 'd' AND topicid = '$deleteid'");
                                                mysql_query("DELETE FROM forumposts WHERE type = 'd' AND topicid = '$deleteid'");}
                                    ...
                                    <table class="miniMenu miniMain forum" style="width: 81%; max-width: 950px;" width="100%" cellspacing="0">
                                        ...
                                        <tr style="text-align: center;">
                                            ...
                                            <td class="statsDivHeader" style="font-size: 11px; background-color: rgba(32,32,32,0.94);" width="10%">Posts</td>
                                                        ...
                                                        <?php
                                                        $selecttopicssql = mysql_query("SELECT * FROM forumtopics WHERE type = 'd' AND id = '1' ORDER BY time DESC");
                                                        $selectstickysql = mysql_query("SELECT * FROM forumtopics WHERE type = 'd' AND id = '2' AND topicid != '5481' ORDER BY time DESC LIMIT 0,50");
                                                        $selectimportantsql = mysql_query("SELECT * FROM forumtopics WHERE type = 'd' AND id = '3' ORDER BY time DESC LIMIT 0,50");
                                                        ...
                                                        while($selectimportant = mysql_fetch_array($selectimportantsql))
                                                        {
                                                            ...
                                                            <?if($i==1){?>
                                                            <tr>
                                                                <td class="statsDiv"><a href="dviewtopic.php?topicid=<?echo$itopicid;?>" style="border-top: 0;"><span style="color: #FFC753;"><b>IMPORTANT</b>:</span> <b><?echo$ititle;?></b><? if($ilocked == 'yes'){?><span style="color: #777777; padding-left: 3px;">(Locked)</span><?}?></a></td>
                                                        ...
                                                        <?}else{?>
                                                            <tr>
                                                                <td class="statsDiv"><a href="dviewtopic.php?topicid=<?echo$itopicid;?>"><span style="color: #FFC753;"><b>IMPORTANT</b>:</span> <b><?echo$ititle;?></b><? if($ilocked == 'yes'){?><span style="color: #777777; padding-left: 3px;">(Locked)</span><?}?></a></td>
                                                        ...
                                                        while($selectsticky = mysql_fetch_array($selectstickysql))
                                                        {
                                                            ...
                                                            ?>
                                                            <tr>
                                                                <td class="statsDiv"><a href="dviewtopic.php?topicid=<?echo$stopicid;?>"><span style="color: #FFC753;"><b>STICKY</b>:</span> <b><?echo$stitle;?></b><? if($slocked == 'yes'){?><span style="color: #777777; padding-left: 3px;">(Locked)</span><?}?></a></td>
                                                        ...
                                                        while($selecttopics = mysql_fetch_array($selecttopicssql))
                                                        {
                                                            ...
                                                            ?>
                                                            <tr>
                                                                <td class="statsDiv"><a href="dviewtopic.php?topicid=<?echo$topicid;?>"><?echo$title;?><? if($locked == 'yes'){?><span style="color: #777777; padding-left: 3px;">(Locked)</span><?}?></a></td>
