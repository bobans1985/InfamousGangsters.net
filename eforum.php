...
$tyn = rand(0, 5);
if ($tyn == '3') {
    $deletetopicssql = mysql_query("SELECT topicid FROM forumtopics WHERE id = '1' AND type = 'e' ORDER BY time DESC LIMIT 25,100");
...
<table cellspacing="0" class="resize" id="block">
    <tr>
        ...
        <td valign="top" class="main">
            ...
            $userinfo = $statustesttwo;
            $userrank = $userinfo['rankid'];
            ...
            $time = time();
            if ($forumtopic) {
                $topicchecksql = mysql_query("SELECT * FROM forumtopics WHERE title = '$forumtopic' AND type = 'e'");
            ...
            if (isset($_POST['do'])) {
                ...
                } elseif (($etest < '1') && ($userrank < '25')) {
                } elseif ($topiccheck > '0') {
                    echo '<font color="white" face="verdana" size="1">A topic with the same name already exists!</font>';
                } else {
                    $topic_dte = date('Y-m-d H:i:s');
                    mysql_query("INSERT INTO forumtopics(creator,id,time,type,title,info,rankid,dte)
VALUES ('$gangsterusername','1','$time','e','$forumtopic','$forumtopicinfo','$userrank','$topic_dte')");
            ...
            if (isset($_POST['clear'])) {
                if ($rank != '100') {
                    echo "<font color=white face=verdana size=1>Nice try</font>";
                } else {
                    $deleteall = mysql_query("SELECT * FROM forumtopics WHERE type= 'e' AND id= '1'");
                    while ($deletealla = mysql_fetch_array($deleteall)) {
                        $deleteid = $deletealla['topicid'];
                        mysql_query("DELETE FROM forumtopics WHERE type = 'e' AND topicid = '$deleteid'");
                        mysql_query("DELETE FROM forumposts WHERE type = 'e' AND topicid = '$deleteid'");
                    }
                    echo "<font color=white face=verdana size=1><b>Forum wiped!</b></font>";
                }
            }

            $guessopen = mysql_query("SELECT * FROM gametimes WHERE game = 'eforumx'");
            $openx = mysql_fetch_array($guessopen);
            $openxox = $openx['time'];

            if ($_POST['openbub']) {
                if ($openxox == 1) {
                    mysql_query("UPDATE gametimes SET time = 0 WHERE game = 'eforumx'");
                    $showoutcome++;
                    $outcome = "You closed the Entertainment Forum!";
                } else {
                    mysql_query("UPDATE gametimes SET time = 1 WHERE game = 'eforumx'");
                    $showoutcome++;
                    $outcome = "You unlocked the Entertainment Forum!";
                }
            }
            ?>
            <? if ($showoutcome >= 1) { ?>
                        ...
                        <div class="main curve2px">
                            ...
                            <div style="padding: 5px; margin: auto; text-align: center; color: #fefefe;">
                                <div style="margin: auto; padding-top: 16px; padding-bottom: 6px; text-align: center;">
                                    <? if ($usernameone == 'Mitch' || $usernameone == 'Nevermore' || $usernameone == 'Imperium' || $usernameone == 'Dispute') {
                                        echo "<form method=post><input type=submit class='textarea inline_form curve3px' name=openbub value='Open/Close!'></form><br><br>";
                                    }
                                    ?>
                                    <? if ($rank == 100) {
                                        echo "<center><form method=post><input type=submit name=clear value='Delete topics' class='textarea inline_form curve3px'></form></center><br>";
                                    } ?>
                                    <table class="miniMenu miniMain forum" style="width: 81%; max-width: 950px;"
                                           width="100%" cellspacing="0">
                                        <tbody>
                                        <tr style="text-align: center;">
                                            <td class="statsDivHeader"
                                                style="font-size: 11px; background-color: rgba(32,32,32,0.94); border-left: 0;">
                                                Title
                                            </td>
                                            <td class="statsDivHeader"
                                                style="font-size: 11px; background-color: rgba(32,32,32,0.94); padding-right: 15px;"
                                                width="20%">Author
                                            </td>
                                            <td class="statsDivHeader"
                                                style="font-size: 11px; background-color: rgba(32,32,32,0.94);"
                                                width="10%">Posts
                                            </td>
                                        </tr>

                                        <?php
                                        $selecttopicssql = mysql_query("SELECT * FROM forumtopics WHERE type = 'e' AND id = '1' ORDER BY time DESC");
                                        $selectstickysql = mysql_query("SELECT * FROM forumtopics WHERE type = 'e' AND id = '2' AND topicid != '5481' ORDER BY time DESC LIMIT 0,50");
                                        $selectimportantsql = mysql_query("SELECT * FROM forumtopics WHERE type = 'e' AND id = '3' ORDER BY time DESC LIMIT 0,50");
                                        ...
                                        while ($selectimportant = mysql_fetch_array($selectimportantsql)) {
                                            ...
                                            if ($iforumrank == 100) {
                                                $rcolor4 = "red><b>";
                                            } elseif ($iforumrank == 25) {
                                                $rcolor4 = "cornflowerblue><b>";
                                            } elseif ($selecthdo > 0) {
                                                $rcolor4 = "lime><b>";
                                            } else {
                                                $rcolor4 = "silver>";
                                            ...
                                            <? if ($i == 1) {
                                                ...
                                                <tr>
                                                    <td class="statsDiv"><a
                                                                href="eviewtopic.php?topicid=<? echo $itopicid; ?>"
                                                                style="border-top: 0;"><span style="color: #FFC753;"><b>IMPORTANT</b>:</span>
                                                            <b><? echo $ititle; ?></b><? if ($ilocked == 'yes') { ?>
                                                                <span style="color: #777777; padding-left: 3px;">(Locked)</span><? } ?>
                                                        </a></td>
                                                    <td class="statsDiv"><a
                                                                href="viewprofile.php?username=<? echo $icreator; ?>"
                                                                style="border-top: 0;"><? echo $icreator; ?></a></td>
                                                    <td class="statsDivStatic"
                                                        style="border-top: 0; color: silver;"><? echo $itopicpost; ?></td>
                                                </tr>
                                            <? } else {
                                                ?>
                                                <tr>
                                                    <td class="statsDiv"><a
                                                                href="eviewtopic.php?topicid=<? echo $itopicid; ?>"><span
                                                                    style="color: #FFC753;"><b>IMPORTANT</b>:</span>
                                                            <b><? echo $ititle; ?></b><? if ($ilocked == 'yes') { ?>
                                                                <span style="color: #777777; padding-left: 3px;">(Locked)</span><? } ?>
                                                        </a></td>
                                                    <td class="statsDiv"><a
                                                                href="viewprofile.php?username=<? echo $icreator; ?>"><? echo $icreator; ?></a>
                                                    </td>
                                                    <td class="statsDivStatic"
                                                        style="color: silver;"><? echo $itopicpost; ?></td>
                                                </tr>
                                            <? } ?>
                                        <? } ?>
                                        <? while ($selectsticky = mysql_fetch_array($selectstickysql)) {
                                            ...
                                            if ($sforumrank == 100) {
                                                $rcolor2 = "red><b>";
                                            } elseif ($sforumrank == 25) {
                                                $rcolor2 = "cornflowerblue><b>";
                                            } elseif ($selecthdo > 0) {
                                                $rcolor2 = "lime><b>";
                                            } else {
                                                $rcolor2 = "silver>";
                                            ...
                                            <tr>
                                                <td class="statsDiv"><a
                                                            href="eviewtopic.php?topicid=<? echo $stopicid; ?>"><span
                                                                style="color: #FFC753;"><b>STICKY</b>:</span>
                                                        <b><? echo $stitle; ?></b><? if ($slocked == 'yes') { ?><span
                                                                style="color: #777777; padding-left: 3px;">(Locked)</span><? } ?>
                                                    </a></td>
                                                <td class="statsDiv"><a
                                                            href="viewprofile.php?username=<? echo $screator; ?>"><? echo $screator; ?></a>
                                                </td>
                                                <td class="statsDivStatic"
                                                    style="color: silver;"><? echo $stopicpost; ?></td>
                                            </tr>
                                        <? } ?>
                                        ...
                                        <? while ($selecttopics = mysql_fetch_array($selecttopicssql)) {
                                            ...
                                            <tr>
                                                <td class="statsDiv"><a
                                                            href="eviewtopic.php?topicid=<? echo $topicid; ?>"><? echo $title; ?><? if ($locked == 'yes') { ?>
                                                            <span style="color: #777777; padding-left: 3px;">(Locked)</span><? } ?>
                                                    </a></td>
                                                <td class="statsDiv"><a
                                                            href="viewprofile.php?username=<? echo $creator; ?>"><? echo $creator; ?></a>
                                                </td>
                                                <td class="statsDivStatic"
                                                    style="color: silver;"><? echo $topicpost; ?></td>
                                            </tr>
                                        <? } ?>
                                        </tbody>
                                    </table>

                                    <? if (($etest < '1') && ($userrank < '25')) {
                                    } else { ?>
                                        <div class="break" style="margin-top: 25px;">
                                            <div class="spacer"></div>
                                            <div class="break" style="margin-top: 4px;">
                                                <form action="" method="post" name="smiley"
                                                      style="padding: 3px; margin: auto; text-align: center; color: #fefefe;">
                                                    <div style="margin: auto; min-width: 220px; width: 65%; max-width: 413px; box-sizing: border-box;">
                                                        <label style="display: inline-block; padding: 12px; padding-bottom: 3px;"
                                                               for="title">Title:</label><br>
                                                        <input type="text" class="textarea inline_form" name="newtopic"
                                                               placeholder="Enter Title..."><br>
                                                        <label style="display: inline-block; padding: 3px; padding-top: 6px;"
                                                               for="msgOrComment">Content:</label><br>
                                                        <textarea name="newtopicinfo" placeholder="Enter Content..."
                                                                  class="textarea inline_form" id="topicinfo"
                                                                  style="height: 130px; width: 100%;"></textarea><br>
                                                        ...
                                                        <input type="submit" value="Create topic!"
                                                               ...
                                                               class="textarea curve3px inline_form" name="do">
                                                    </div>
                                                </form>
                                                ...
                                                <div class="break" style="margin-top: 15px;">
                                                    ...
                                                    <div class="break" style="margin-top: 4px;">
                                                        <div style="padding: 20px; text-align: center; font-size: 11px;">
                                                            <?
                                                            $ent_managers = mysql_query("SELECT * FROM users WHERE rankid = '50'");
                                                            $ents = mysql_query("SELECT * FROM entertainers");
                                                            ?>
                                                            E.Manager:
                                                            <?
                                                            $cont=0;
                                                            while($ent_manager = mysql_fetch_array($ent_managers)) {
                                                                $cont++;
                                                                if($cont==1){
                                                                    echo '<a href="viewprofile.php?username='.$ent_manager['username'].'"><b style="color: yellow; font-size: 11px;">'.$ent_manager['username'].'</b></a>';
                                                                }else{
                                                                    echo ', <a href="viewprofile.php?username='.$ent_manager['username'].'"><b style="color: yellow; font-size: 11px;">'.$ent_manager['username'].'</b></a>';
                                                                }
                                                            }
                                                            ...
                                                            <?
                                                            $cont=0;
                                                            while($ent = mysql_fetch_array($ents)) {
                                                                $cont++;
                                                                if($cont==1){
                                                                    echo '<a href="viewprofile.php?username='.$ent['username'].'"><b style="color: pink; font-size: 11px;">'.$ent['username'].'</b></a>';
                                                                }else{
                                                                    echo ', <a href="viewprofile.php?username='.$ent['username'].'"><b style="color: pink; font-size: 11px;">'.$ent['username'].'</b></a>';
                                                                }
                                                            }
