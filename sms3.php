...
<?php } ?>
  ...
  <table align="center" width="55%" cellpadding="0" cellspacing="1" class="section">
    ...
    <tr>
      <td><div class="button1"><input type="radio" onclick="window.location='/sms3.php';" /><font color=yellow><b>800<?php if($smstimes != 1){ ?><font color=khaki> *<?php echo $smstimes ?></font><?php } ?> Points</b></font> [�9.00] - <b>SELECTED</b></div></td>
    </tr>
  </table><br><center><h2><font face="verdana" color="white">Text <b>GL shot</b> to <b>87070</b></font></h2>
  ...
  <input type="hidden" name="ddi_id" value="13283">
  <br><br>
