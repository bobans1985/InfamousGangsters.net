<? include 'included.php'; session_start(); session_start(); ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8"/>
...
<table cellspacing="0" class="resize" id="block">
    <tr>
        ...
        <td valign="top" class="main">
            ...
            if(isset($_POST['add'])){
                if(!$word){}else{$showoutcome++; $outcome = "Word has now been filtered!</font>";
                                ...
                                <div style="margin: auto; width: 93%; padding-top: 16px; padding-bottom: 6px; text-align: center;">
                                    <table align="center" width="85%" cellpadding="0" cellspacing="1" class="section">
                                        <form action="" method="post" style="text-align: center;">
                                            <input type="text" name="add" class="textarea">
                                            <input type="submit" name="do" value="Filter word" class="textarea">
                                        </form>
                                    </table>
                                </div>
                            </div>
