...
$sendinfo = "\[br\]\[center\]Welcome to Infamous Gangsters!\[br\]If you click Game Network, then click on FAQ on your leftmenu it will give you all basic information on the game.\[br\]You are currently under 48 hours protection from being killed.\[\/center\]\[br\]\[br\]\[b\]\[color=yellow\]Tips:\[\/color\]\[\/b\] Make money fast by doing \[b\]\[color=yellow\]Crimes\[\/color\]\[\/b\], \[b\]\[color=yellow\]City Crime\[\/color\]\[\/b\] and \[b\]\[color=yellow\]Steal Cars\[\/color\]\[\/b\]\[br\]\[br\]If you are not sure what to do or how to do something, you can ask a question on the \[b\]\[color=silver\]Get Help\[\/color\]\[\/b\] page and wait for a staff member to answer :)\[br\] NOTE: You can block casinos by going to Edit Profile and clicking Casino Settings and then click Block.";
...
<? if($_GET['ref']){ $addthis = "?ref=$refraw"; }else{ $addthis = ""; } ?>
</html>
