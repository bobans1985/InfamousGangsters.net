...
$lasttensql = mysql_query("SELECT * FROM moneysent WHERE username = '$name' ORDER BY id DESC");

$lasttenrsql = mysql_query("SELECT * FROM moneysent WHERE sent = '$name' ORDER BY id DESC");

?>
<table align="center" cellpadding="0" width=100% cellspacing="0">
<tbody><tr>
<td class=menutopleft><img style="display: block" height=22 width=8 src="blank.gif" after alt=""></td>
<td class=menutopbar height=22 style="white-space: nowrap"><font color="#222222"><b>Users sent cash</b></font></td>
...
if($qt == 'yes'){ echo"<tr><td bgcolor=#222222 NOWRAP><a href=viewprofile.php?username=$name><font color=khaki size=1 face=verdana>$name</a><font color=white> sent $<b>$lasttenamount</b> to <a href=viewprofile.php?username=$lasttento><font color=khaki size=1 face=verdana>$lasttento</font></a> (QT)</td></tr>";}
else{ echo"<tr><td bgcolor=#222222 NOWRAP><a href=viewprofile.php?username=$name><font color=khaki size=1 face=verdana>$name</a><font color=white> sent $<b>$lasttenamount</b> to <a href=viewprofile.php?username=$lasttento><font color=khaki size=1 face=verdana>$lasttento</font></a></td></tr>";}}?>
</table></td>
...
if($qt == 'yes'){ echo"<tr><td bgcolor=#222222 NOWRAP><a href=viewprofile.php?username=$name><font color=khaki size=1 face=verdana>$name</a><font color=white> recieved $<b>$lasttenramount</b> from </font><a href=viewprofile.php?username=$lasttenrto><font color=khaki size=1 face=verdana>$lasttenrto</font></a> (QT)</td></tr>";}
else{ echo"<tr><td bgcolor=#222222 NOWRAP><a href=viewprofile.php?username=$name><font color=khaki size=1 face=verdana>$name</a><font color=white> recieved $<b>$lasttenramount</b> from </font><a href=viewprofile.php?username=$lasttenrto><font color=khaki size=1 face=verdana>$lasttenrto</font></a></td></tr>";}}?>
