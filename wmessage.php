    ...
    <tr>
        ...
        <td valign="top" class="main">
            ...
            if(isset($_POST['editprofile'])) {
                mysql_query("UPDATE crews SET wmessage = '$profilesubmit' WHERE boss = '$gangsterusername'");

                $showoutcome++; $outcome = "Welcome message updated!";
            }
            ...
            $getuserprofile = $getuserinfoarray['wmessage'];
                        ...
                        <div class="main curve2px">
                            ...
                            <div style="padding: 5px; margin: auto; text-align: center; color: #fefefe;">
                                <div style="margin: auto; padding-top: 16px; padding-bottom: 6px; text-align: center;">
                                        <form action="" method="post" name="smiley" style="text-align: center;">
                                            <textarea style="text-align: left;" name="editprofile" cols="60" rows="20" class="textarea" id ="editprofile"><?php echo $userprofile;?></textarea><br>
                                            <input type ="submit" value="Set Message!" class="textarea curve3px">
                                        </form>
                                </div>
                            </div>
                        </div>
