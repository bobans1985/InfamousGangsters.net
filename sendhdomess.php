...
$getmembers = mysql_query("SELECT * FROM hdos");
...
VALUES ('$gangsterusername','8022','hdof','$sendinfo','$playerrank','1')");
$showoutcome++; $outcome = "<font color=white face=verdana size=1>Your message to all the hdos been sent!</font>";}}
...
<td class=menutopbar height=22 style="white-space: nowrap"><font color="#222222"><b>Send HDO Message</b></font></td>
