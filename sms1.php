...
if($ref != "http://www.glpayment.co.uk/glpay0205/Auth_Standard.php"){ die('FOOL'); }
...
<?php } ?>
  ...
  <table align="center" width="55%" cellpadding="0" cellspacing="1" class="section">
    ...
    <tr>
      <td><div class="button1"><input type="radio" onclick="window.location='/sms1.php';" />
        250<?php if($smstimes != 1){ ?><font color=khaki> *<?php echo $smstimes ?></font><?php } ?> Points [�3.00] - <b>SELECTED</b></b></div></td>
    </tr>
    <tr>
  ...
  </table><br><center><h2><font face="verdana" color="white">Text <b>GL prem</b> to <b>87070</b></font></h2>
    <h3><font face="verdana" color="white">Or</font>    </h3>
      <h2><font face="verdana" color="white">DIAL 0906 635 1706</font> </h2><br><br><font face="verdana" size=1 color="white">After you have completed 1 of the options above you will be given a 10 digit unique code please type it in bellow to recieve your points!</font>
  ...
  <input type="hidden" name="ddi_id" value="13281">
  <br><br>
