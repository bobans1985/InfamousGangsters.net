        ...
        <td valign="top" class="main">
			...
			$showcaptcha = false;
										...
										if (isset($_POST['captcha_btn'])) {
											if($_POST['captcha'] != $_SESSION['rand_code']) echo "Captcha not correct!";
											else echo "Captcha correct!";
										}*/
							...
							for($i=0;$i<$n;$i++){
								if($doit_str = $doit[$i]){
									...
									if($ifnotname == $gangsterusername){
										...
										if($crewid == 0){
											$showoutcome++; $outcome = "You melted the car! You received <b>$totalbullets</b> bullets!"; }else{
											$showoutcome++; $outcome = "You melted the car! You received <b>$totalbullets</b> bullets, Your crew took <b>$theperc</b>% of them!";
										}
									}
								}
							}
...
<!--                                    </form>-->
                                    <form action="melt.php" method="post" id="table_melt">
                                                ...
                                                while($carlists = mysql_fetch_array($carlist)){
                                                    ...
                                                    <?if($contador==1){?>
                                                        <tr class="row" id="car_<?echo$carida;?>">
                                                            ...
                                                            <td class="col noTop"><span style="color: #aaaaaa;"><?echo$carbullets;?> bullets</span><input type=checkbox name=id value="<?echo$carida;?>" style='vertical-align:middle;visibility:hidden;width:1px;'></td>
                                                    ...
                                                    <?}else{?>
                                                        <tr class="row" id="car_<?echo$carida;?>">
                                                            ...
                                                            <td class="col"><span style="color: #aaaaaa;"><?echo$carbullets;?> bullets</span><input type=checkbox name=id value="<?echo$carida;?>" style='vertical-align:middle;visibility:hidden;width:1px;'></td>
										...
										<?php if ($page > 1): ?>
											<a href="melt.php?page=<?=($page - 1)?>" class="textarea curve3px" style="opacity: 0.5; padding-left: 9px; padding-right: 9px;">Prev page</a>
										<?php endif; ?>
										<?php if ($page < $total_pages && $total_pages > 1): ?>
											<a href="melt.php?page=<?=($page + 1)?>" class="textarea curve3px" style="padding-left: 9px; padding-right: 9px;">Next page</a>
										<?php endif; ?>
										</div>
