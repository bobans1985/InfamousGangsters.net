...
<table cellspacing="0" class="resize" id="block">
    <tr>
        ...
        <td valign="top" class="main">
            ...
            $editsql = mysql_query("SELECT * FROM forumtopics WHERE topicid = '$topicid' AND type = 'hdof'");
            $editarray = mysql_fetch_array($editsql);
            $editname = $editarray['creator'];
            $posttits = $editarray['posts'];
            $titdate = $editarray['dte'];
            if(($rankid >= '50')||($editname == $gangsterusername)||($ahdoperson > '0')){
                if(isset($_POST['edit'])) { if(!$edittopic){}else{
                    mysql_query("UPDATE forumtopics SET info = '$edittopic' WHERE topicid = '$topicid' AND type = 'hdof'");
                }}}
            ...
            if(isset($_POST['dopost'])) {
                ...
                elseif($topiccheck == '0'){$showoutcome++; $outcome = '<font color=red face=verdana size=1><b>No such topic!</b></font><META HTTP-EQUIV="Refresh" CONTENT="2; URL=staffforum.php">';}
                else{
                    $posttits++;
                    if(($senior == '1')&&($playerrank < '25')){$playerrank = '123';}
                    mysql_query("UPDATE forumtopics SET time = '$time' WHERE topicid = '$topicid' AND type = 'hdof'");
...
VALUES ('$gangsterusername','$topicid','$userip','$post_time','hdof','$newpost','$playerrank','1','$reply_user')");
                    }else{
                        mysql_query("INSERT INTO forumposts(username,topicid,ip,time,type,post,rankid,esc)
VALUES ('$gangsterusername','$topicid','$userip','$post_time','hdof','$newpost','$playerrank','1')");
                    }
            ...
            if(($rankid == '100')||($rankid == '75')||($rankid == '50')||($rankid == '25')||($hdoperson > '0')){
                if(isset($_POST['delete'])) {
                    mysql_query("DELETE FROM forumtopics WHERE type = 'hdof' AND topicid = '$topicid'");
                    mysql_query("DELETE FROM forumposts WHERE type = 'hdof' AND topicid = '$topicid'");
                }}

            if(($rankid == '100')||($rankid == '75')||($rankid == '50')||($rankid == '25')){
                if(isset($_POST['dj'])) { mysql_query("UPDATE forumtopics SET id = '6' WHERE topicid = '$topicid' AND type = 'hdof'");
                }}

            if(($rankid == '100')||($rankid == '75')||($rankid == '50')||($rankid == '25')){
                if(isset($_POST['sticky'])) {
                    mysql_query("UPDATE forumtopics SET id = '7' WHERE topicid = '$topicid' AND type = 'hdof'");
                }}

            if(($rankid == '100')||($rankid == '75')||($rankid == '50')||($rankid == '25')){
                if(isset($_POST['important'])) {
                    mysql_query("UPDATE forumtopics SET id = '8' WHERE topicid = '$topicid' AND type = 'hdof'");
                }}

            if($rankid == '100'){
                if(isset($_POST['update'])) {
                    mysql_query("UPDATE forumtopics SET id = '5' WHERE topicid = '$topicid' AND type = 'hdof'");
                }}
            ...
            if(($topiccreator == $gangsterusername)||($rankid == '100')||($rankid == '75')||($rankid == '50')||($rankid == '25')||($hdoperson > '0')){
                if(isset($_GET['lock'])) { $showoutcome++; $outcome = '<font color=white face=verdana size=1>Topic locked</font>';mysql_query("UPDATE forumtopics SET locked = 'yes' WHERE topicid = '$topicid' AND type = 'hdof'");}
            }

            if(($rankid == '100')||($rankid == '75')||($rankid == '50')||($rankid == '25')||($hdoperson > '0')){
                if(isset($_GET['unlock'])) {$showoutcome++; $outcome = '<font color=white face=verdana size=1>Topic Unlocked</font>';mysql_query("UPDATE forumtopics SET locked = 'no' WHERE topicid = '$topicid' AND type = 'hdof'");}
            }
            ...
            if(($rankid >= '25')||($hdoperson > '0')){
                if(isset($_GET['deletepost'])) {
                    mysql_query("DELETE FROM forumposts WHERE type = 'hdof' AND topicid = '$topicid' AND id = '$deletepost'");
                    mysql_query("UPDATE forumtopics SET time = '$time', posts = (posts - 1)  WHERE topicid = '$topicid' AND esc = '0'");
                }}

            $gettopicid = mysql_query("SELECT * FROM forumtopics WHERE topicid = '$topicid' AND type = 'hdof'");
            $gettopicidarray = mysql_fetch_array($gettopicid);
            $exists = mysql_num_rows($gettopicid);
            if($exists == '0'){$showoutcome++; $outcome = '<font color=red face=verdana size=1><b>No such topic!</b></font><META HTTP-EQUIV="Refresh" CONTENT="2; URL=staffforum.php">';}
                            ...
                            <div style="display: table; width: 100%; padding: 9px; padding-top: 5px; padding-bottom: 5px;">
                                ...
                                <div style="display: table-cell; text-align: right;">
                                    ...
                                    if(($topiccreator == $gangsterusername)||($rankid >= '25')||($hdoperson > '0')){
                                        ...
                                        echo"<a href=sviewtopic.php?topicid=$topicid&lock=1 style=color:$cu;><b> Lock </b></a>";}
                                    if(($rankid >= '25')||($ahdo > '0')){
                                        if($toplocked == 'yes'){$cu = 'white';}
                                        else{$cu='white';}
                                        echo"<span class=\"miniSep\"> - </span><a href=sviewtopic.php?topicid=$topicid&unlock=1 style=color:$cu;><b>Unlock </b></a>";
                                    }?>
                                </div>
            ...
            <div id=editee style="display:none;" name=edit>
                <div style="margin: auto; max-width: 413px;">
                    <form action="sviewtopic.php?topicid=<?echo$topicid;?>" method="post" name="smileys" style="text-align: center;">
            ...
            <? $countposts = mysql_num_rows(mysql_query("SELECT * FROM forumposts WHERE topicid = '$topicid' AND esc = '1'"));?>
                <form action = "sviewtopic.php?topicid=<?echo$topicid;?>" method = "post" style="padding: 7px; text-align: center;">
            ...
            <?php
            $getposts = mysql_query("SELECT * FROM forumposts WHERE topicid = '$topicid' AND type = 'hdof' ORDER BY id DESC LIMIT $selectfrom,$selectto ");
            ...
            <script>
                function nogetitnow<?echo$postid;?>(){
                    ...
                    ajaxRequest.open("GET", "nookcomment.php?id=" + urnamed + strhehefd, true);
                    ajaxRequest.send(null);
                    ...
                    ajaxRequest.onreadystatechange = function(){
                        if(ajaxRequest.readyState == 4){
                            ...
                            else{document.getElementById("u<?echo$postid;?>").innerHTML = " ";document.getElementById("v<?echo$postid;?>").innerHTML = " ";}
                        }}}
            </script>
            ...
            <?php if(($rankid >= '25')||($hdoperson > '0')||($usernameone == 'frfrfrfffggfgrrf')){?>
            <table class="menuTable curve10px" cellspacing="0" cellpadding="0">
                <tbody><tr>
                    <td class="topleft"></td>
                    <td class="top"></td>
                ...
                <tr>
                    ...
                    <input type ="submit" value="NORMAL" class=\'textarea inline_form curve3px\' name="undo">';
                            ...
                            <div style="margin: auto; max-width: 413px;">
                                <form action="sviewtopic.php?topicid=<?echo$topicid;?>" method="post" name="smiley" style="text-align:center;">
