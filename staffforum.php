...
$tyn = rand(0,7);
if($tyn == '3'){
    $deletetopicssql = mysql_query("SELECT topicid FROM forumtopics WHERE id = '1' AND type = 'hdof' ORDER BY time DESC LIMIT 34,35");
                        ...
                        <div class="main curve2px">
                            ...
                            <div style="padding: 5px; margin: auto; text-align: center; color: #fefefe;">
                                <div style="margin: auto; padding-top: 16px; padding-bottom: 6px; text-align: center;">
                                    ...
                                    $thdo = mysql_num_rows(mysql_query("SELECT * FROM traineehdos WHERE username = '$gangsterusername'"));
                                    $ahdo = mysql_num_rows(mysql_query("SELECT * FROM hdos WHERE username = '$gangsterusername'"));
                                    $shdo = mysql_num_rows(mysql_query("SELECT * FROM senior WHERE username = '$gangsterusername'"));
                                    $newswriter = mysql_num_rows(mysql_query("SELECT * FROM news WHERE username='$usernameone'"));
                                    if(($rank >= '25')||($ahdo >= '1')){}else{die('<font color=white face=verdana size=1>You can not view this page</font>');}
                                    ...
                                    if($forumtopic){
                                        ...
                                        $topicchecksqltwo = mysql_query("SELECT * FROM forumtopics WHERE creator = '$gangsterusername' AND id = '5' AND type = 'hdof'");
...
VALUES ('$gangsterusername','5','$time','hdof','$forumtopic','$forumtopicinfo','$rank','$topic_dte','hdof')");
                                    ...
                                    if(isset($_POST['dop'])) {
                                        ...
                                        elseif($topiccheck > '0'){ echo'<font color="white" face="verdana" size="1">A topic with the same name already exists!</font>';}
                                        elseif($topicchecktwo > '10'){ echo'<font color="white" face="verdana" size="1">You cannot have more than 10 topics on the forum at one time!</font>';}
                                        else{mysql_query("INSERT INTO forumtopics(creator,id,time,type,title,info,rankid,esc)
VALUES ('$gangsterusername','9','$time','hdof','$forumtopic','$forumtopicinfo','$rank','hdof')");
                                            mysql_query("UPDATE users SET topics = (topics + 1) WHERE ID = '$ida'");}
                                    }
                                    ...
                                    include 'entteam.php';
                                    include 'hdoteam.php';
                                    include 'hdoteam1.php';
                                    include 'hdoteam2.php';
                                    ?>
                                    <table class="miniMenu miniMain forum" style="width: 81%; max-width: 950px;"
                                        ...
                                        <?php
                                        $selecttopicssql = mysql_query("SELECT * FROM forumtopics WHERE type = 'hdof' AND id = '5' ORDER BY time DESC");

                                        $selectstickysql = mysql_query("SELECT * FROM forumtopics WHERE type = 'hdof' AND id = '7' ORDER BY time DESC LIMIT 0,50");

                                        $selectimportantsql = mysql_query("SELECT * FROM forumtopics WHERE type = 'hdof' AND id = '8' ORDER BY time DESC LIMIT 0,50");

                                        $selectautosql = mysql_query("SELECT * FROM forumtopics WHERE type = 'hdof' AND id = '9' ORDER BY time DESC LIMIT 0,50");

                                        $selectdjsql = mysql_query("SELECT * FROM forumtopics WHERE type = 'hdof' AND id = '6' ORDER BY time DESC");
                                        ...
                                        while($selectimportant = mysql_fetch_array($selectautosql))
                                        {
                                            ...
                                            $selecthdo = mysql_num_rows(mysql_query("SELECT * FROM hdos WHERE username = '$icreator'"));
                                            if($iforumrank == 100){ $rcolor4 = "red><b>"; }elseif($iforumrank == 25){ $rcolor4 = "cornflowerblue><b>"; }elseif($selecthdo > 0){ $rcolor4 = "lime><b>"; }else{ $rcolor4 = "silver>"; }
                                            ...
                                            <tr>
                                                <td class="statsDiv"><a
                                                            href="sviewtopic.php?topicid=<? echo $itopicid; ?>"
                                        ...
                                        <? } else {
                                            ...
                                            <tr>
                                                <td class="statsDiv"><a
                                                            href="sviewtopic.php?topicid=<? echo $itopicid; ?>"><span
                                        ...
                                        while($selectsticky = mysql_fetch_array($selectstickysql))
                                        {
                                            ...
                                            if($sforumrank == 100){ $rcolor3 = "red><b>"; }elseif($sforumrank == 25){ $rcolor3 = "cornflowerblue><b>"; }elseif($selecthdo > 0){ $rcolor3 = "lime><b>"; }else{ $rcolor3 = "silver>"; }
                                            ...
                                            <tr>
                                                <td class="statsDiv"><a
                                                            href="sviewtopic.php?topicid=<? echo $stopicid; ?>"><span
                                        ...
                                        while($selectdj = mysql_fetch_array($selectdjsql))
                                        {
                                            ...
                                            $selecthdo = mysql_num_rows(mysql_query("SELECT * FROM hdos WHERE username = '$screator' AND type = 'senior'"));
                                            if($sforumrank == 100){ $rcolor2 = "red><b>"; }elseif($sforumrank == 25){ $rcolor2 = "cornflowerblue><b>"; }elseif($selecthdo > 0){ $rcolor2 = "lime><b>"; }else{ $rcolor2 = "silver>"; }
                                            ...
                                            <tr>
                                                <td class="statsDiv"><a
                                                            href="sviewtopic.php?topicid=<? echo $stopicid; ?>"><b><? echo $stitle; ?></b><? if ($slocked == 'yes') { ?>
                                                            <span style="color: #777777; padding-left: 3px;">(Locked)</span><? } ?>
                                                    </a></td>
                                                <td class="statsDiv"><a
                                                            href="viewprofile.php?username=<? echo $screator; ?>"><? echo $screator; ?></a>
                                        ...
                                        while($selecttopics = mysql_fetch_array($selecttopicssql))
                                        {
                                            ...
                                            if($forumrank == 100){ $rcolor = "red><b>"; }elseif($forumrank == 25){ $rcolor = "cornflowerblue><b>"; }elseif($selecthdo > 0){ $rcolor = "lime><b>"; }else{ $rcolor = "silver>"; }
                                            ...
                                            <tr>
                                                <td class="statsDiv"><a
                                                            href="sviewtopic.php?topicid=<? echo $topicid; ?>"><? echo $title; ?><? if ($locked == 'yes') { ?>
                                                            <span style="color: #777777; padding-left: 3px;">(Locked)</span><? } ?>
                                                    </a></td>
                                                <td class="statsDiv"><a
...
$acount = mysql_num_rows(mysql_query("SELECT * FROM users WHERE crewid='$getcrewid' and activity >= '$timetwo'"));
            ...
            <table class="menuTable curve10px" cellspacing="0" cellpadding="0">
                ...
                <div style="padding: 10px; font-size: 9.5px; opacity:0.7; text-align: center;">
                    You can mute sounds in <a href="profile.php">Edit Profile</a>
                </div>
            <?}?>
        </td>
    </tr>
