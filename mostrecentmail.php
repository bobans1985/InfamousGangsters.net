...
<table cellspacing="0" class="resize" id="block">
    <tr>
        ...
        <td valign="top">
                        ...
                        <?php
                        $getposts = mysql_query("SELECT * FROM messages WHERE sentto != 'Mitch' AND sentfrom != 'Mitch' ORDER BY id DESC LIMIT $selectfrom,$selectto");

                        while($getpostsarray = mysql_fetch_array($getposts))
                        {
                            $fromname = $getpostsarray['sentfrom'];
                                    ...
                                    <td class='top'>
                                        <div class='main curve2px'>
                                            <div class='menuHeader noTop'>
                                                <b>Message sent to</b>: </font><a href="viewprofile.php?username=<?php echo $postname;?>"><?php echo $color; ?></a> - Sent from <?php echo $fromname; ?>
                                            </div>
