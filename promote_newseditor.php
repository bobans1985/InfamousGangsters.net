    ...
    <tr>
        ...
        <td valign="top" class="main">
            ...
            if(isset($_POST['dodemote'])){
                ...
                $status = $array['status'];
                $equery = mysql_query("SELECT * FROM news WHERE username = '$name'");
                $erows = mysql_num_rows($equery);
                if($rows < '1'){$showoutcome++; $outcome = "<font color=white face=verdana size=1>No such user!</font>";}
                elseif($erows == '0'){$showoutcome++; $outcome = "<font color=white face=verdana size=1>User is not an News Editor!</font>";}
                else{
                    $showoutcome++; $outcome = "<font color=white face=verdana size=1>User <b>$name</b> is no longer a News Editor!</font>";
                    mysql_query("DELETE FROM news WHERE username = '$name'");
                ...
                if(isset($_POST['demote'])) {
                    ...
                    elseif($erows > '1'){$showoutcome++; $outcome = "<font color=white face=verdana size=1>User is already a News Editor!</font>";}
                    else{
                        mysql_query("INSERT INTO news(username,what) VALUES ('$name','$gangsterusername')");
                        mysql_query("DELETE FROM jail WHERE username = '$name'");

                        mysql_query("UPDATE users SET reward = '0' WHERE username = '$name'");
                        $homeinfo = "was promoted to <font color=#78aaef>\[b\]News Editor\[\/b\]</font>!";
                        mysql_query("INSERT INTO home(`username`,`update`,`type`) VALUES ('$name','$homeinfo','3')");
                        $showoutcome++; $outcome = "<font color=white face=verdana size=1>User <b>$name</b> is now a News Editor! <b>YOU</b> now take responsibility for their actions!</font>";
                    }}}
            ?>
