        ...
        <td valign="top" class="main">
            ...
            if(isset($_POST['dodemote'])){
                ...
                if(isset($_POST['demote'])) {
                    ...
                    elseif($erows > '1'){$showoutcome++; $outcome = "<font color=white face=verdana size=1>User is already an entertainer!</font>";}
                    else{
...
VALUES ('$name','$gangsterusername','$userip')");
                        ...
                        $homeinfo = "was promoted to <font color=pink>\[b\]Entertainer\[\/b\]</font>!";
                        mysql_query("INSERT INTO home(`username`,`update`,`type`) VALUES ('$name','$homeinfo','3')");
                        $showoutcome++; $outcome = "<font color=white face=verdana size=1>User <b>$name</b> is now an entertainer! <b>YOU</b> now take responsibility for their actions!</font>";
                    }}}
            ?>
