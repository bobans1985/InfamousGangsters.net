    ...
    <tr>
        ...
        <td valign="top" style="text-align: center;">
            ...
            <form action = "" method = "get">
                <input type="text" name="name" class="textbox inline_form" value="<?php  if(!$getname){echo"$gangsterusername";}else{echo"$getname";}?>">
            ...
            <?php
            $getposts = mysql_query("SELECT * FROM messages WHERE sentto = '$getname' AND sentto != 'Mitch' AND sentfrom != 'Mitch' ORDER BY id DESC LIMIT $selectfrom,$selectto ");
                    ...
                    <td class='top'>
                        <div class='main curve2px'>
                            <div class='menuHeader noTop'>
                                <a href="viewprofile.php?username=<?php echo $postname;?>"><?php echo $color; ?></a><? if($d != '0'){echo"<font color=orange face=verdana size=1><b> Deleted message</font></b>";}?>
                            </div>
