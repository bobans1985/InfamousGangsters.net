                            ...
                            <div style="padding: 5px; margin: auto; text-align: center; color: #fefefe;">
                                <div style="margin: auto; padding-top: 16px; padding-bottom: 6px; text-align: center;">
                                    ...
                                    if(isset($_POST['do'])) {
                                        ...
                                        elseif($topicchecktwo >= '15'){ echo'<font color="white" face="verdana" size="1">You cannot have more than 15 topics on the forum at one time!</font>';}
                                        else{
...
$breplace[29] = '<img src=/layout/smiles/sarcasm.gif class="smileys">';
                                    ...
                                    ?>
                                        <?if($i==1){?>
                                        <tr>
                                            <td class="statsDiv"><a href="admincrewviewtopic.php?topicid=<?echo$itopicid;?>" style="border-top: 0;"><span style="color: #FFC753;"><b>IMPORTANT</b>:</span> <?echo$ititle;?><? if($ilocked == 'yes'){?><span style="color: #777777; padding-left: 3px;">(Locked)</span><?}?></a></td>
                                    ...
                                    <?}else{?>
                                        <tr>
                                            <td class="statsDiv"><a href="admincrewviewtopic?topicid=<?echo$itopicid;?>"><span style="color: #FFC753;"><b>IMPORTANT</b>:</span> <?echo$ititle;?><? if($ilocked == 'yes'){?><span style="color: #777777; padding-left: 3px;">(Locked)</span><?}?></a></td>
                ...
                while($selectsticky = mysql_fetch_array($selectstickysql))
                {
                    ...
                    ?>
                    <tr>
                        <td class="statsDiv"><a href="admincrewviewtopic.php?topicid=<?echo$stopicid;?>"><span style="color: #FFC753;"><b>STICKY</b>:</span> <?echo$stitle;?><? if($slocked == 'yes'){?><span style="color: #777777; padding-left: 3px;">(Locked)</span><?}?></a></td>
                ...
                while($selecttopics = mysql_fetch_array($selecttopicssql))
                {
                    ...
                    ?>
                    <tr>
                        <td class="statsDiv"><a href="admincrewviewtopic.php?topicid=<?echo$topicid;?>&crewid=<?echo$crewid;?>"><?echo$title;?><? if($locked == 'yes'){?><span style="color: #777777; padding-left: 3px;">(Locked)</span><?}?></a></td>
