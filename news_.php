...
VALUES ('$gangsterusername',' ','$userip','news','$newpost','$playerrank')");
            ...
            <?php  if(($myrank >= '25')){?>
                ...
                <div style="padding: 20px; text-align: center; font-size: 11px;">
                    <?
                    $ents = mysql_query("SELECT * FROM news");
                    ?>
                    News Editor Manager:
                    <?
                        echo '<span style="color: gray;  font-size: 11px;">There is currently no News Editor Manager.</span>';
                    ?>
                    &nbsp;&nbsp;&nbsp;
                    News Editors:
                    <?
                    ...
                    while($ent = mysql_fetch_array($ents)) {
                        $cont++;
                        if($cont==1){
                            echo '<a href="viewprofile.php?username='.$ent['username'].'"><b style="color: #78aaef;; font-size: 11px;">'.$ent['username'].'</b></a>';
                        }else{
                            echo ', <a href="viewprofile.php?username='.$ent['username'].'"><b style="color: #78aaef;; font-size: 11px;">'.$ent['username'].'</b></a>';
                        }
                    }
                    if($cont==0){
                        echo '<span style="color: gray;  font-size: 11px;">There is currently no News Editor.</span>';
                    }
                    ?>
                </div>
