                        ...
                        <div class="main curve2px">
                            ...
                            <div style="padding: 5px; margin: auto; text-align: center; color: #fefefe;">
                                <div style="margin: auto; padding-top: 16px; padding-bottom: 6px; text-align: center;">
                                    ...
                                    if($_POST['do'] AND $howmanysupers < 5) {
                                        ...
                                        if($superone != 1){ $carname = 'Bugatti Veyron'; $link = '14'; $bullets = '350'; $speed = '0'; }
                                        elseif($supertwo != 1){ $carname = 'Ferrari 458 Italia'; $link = '15'; $bullets = '350'; $speed = '0'; }
                                        elseif($superthree != 1){ $carname = 'Lamborghini Murcielago'; $link = '16'; $bullets = '350'; $speed = '0'; }
                                        elseif($superfour != 1){ $carname = 'Koenigsegg Agera R'; $link = '17'; $bullets = '350'; $speed = '0'; }
                                        elseif($superfive != 1){ $carname = 'Lamborghini Aventador'; $link = '18'; $bullets = '350'; $speed = '0'; }
                                        elseif($superfive != 1){ $carname = 'Audi Prologue'; $link = '19'; $bullets = '350'; $speed = '0'; }
...
VALUES ('$gangsterusername','$cardamage','$bullets','$link','$speed')");
                                    ...
                                    <table align="center" width="85%" cellpadding="0" cellspacing="1" class="section">
                                        <br><center><form action="" method="post"><input type="submit" value="Get Super" class="textarea curve3px" name="do"></center><br></form>
                                        </tbody></table>
                                </div>
                            </div>
                        </div>
