        ...
        <td valign="top" class="main">
            ...
            if(isset($_GET['id'])){
                if($idcheck < '1'){die('<font color=white face=verdana size=1>ID is invalid</font>');}
                    ...
                    $showoutcome++; $outcome = "<font color=white face=verdana size=1>Pen points cleared!</font>";}}

            $topten = mysql_query("SELECT * FROM users WHERE status != 'Dead' AND status != 'Modkilled' AND penpoints > '0' ORDER BY penpoints DESC");
                            ...
                            <div style="padding: 5px; margin: auto; text-align: center; color: #fefefe;">
                                <div style="margin: auto; width: 93%; padding-top: 16px; padding-bottom: 6px; text-align: center;">
                                    <table class="regTable" style="min-width:200px; width: 80%; max-width: 540px;" cellspacing="0" cellpadding="0" align="center">
                                        <tbody><tr>
                                            <td class="header" colspan="3" style="padding: 11px 0px;">
                                                Penalty Points
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="subHeader">Username:</td>
                                            <td class="subHeader">Reasons:</td>
                                        ...
                                        while($toptena = mysql_fetch_array($topten)){
                                            ...
                                            $playerid = $toptena['ID'];?>
                                            <tr>
                                                <td class="col " style="text-align: center;padding-right: 10px;">
                                                    <a href=viewprofile.php?username=<?echo$refname;?>><?echo$refname;?></a>
                                                </td>
                                                <td class="col " style="text-align: center;padding-right: 10px;">
                                                    <a href=penreason.php?user=<?echo$refname;?>>Reasons</a>
                                                </td>
                                                <td class="col " style="text-align: center;padding-right: 10px;">
                                                    <span style="color:gold;"><?php echo $refc;?></span>
                                                    <a href=penaltypoints.php?id=<?echo$playerid;?>>(Clear)</a>
                                                </td>
                                            </tr>
                                        <?}?>
                                        </tbody>
