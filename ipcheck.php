                        ...
                        <div class="main curve2px">
                            ...
                            <div style="padding: 5px; margin: auto; text-align: center; color: #fefefe;">
                                <div style="margin: auto; width: 93%; padding-top: 16px; padding-bottom: 6px; text-align: center;">
                                    ...
                                    if($rankkk == '100'){die('<font color=white face=verdana size=1>Of course we admins dont dupe, Silly you!</font>');}
                                    ...
                                    <table align="center" width="85%" cellpadding="0" cellspacing="1" class="section">
                                        <form method=post>
                                            <input type="text" name="usersname" class="textarea" placeholder="Enter a Username...">
                                            <input type="submit" name="doit" class="textarea" value="Search..."></form><br/>
                                        <?
                                            if(!$find){

                                            }elseif($findgangsternumrows == '0') {
                                            }else{
                                                echo"<br><font color=silver face=verdana size=1><b>Latest IP:</font></b><br><b><a href=duperesults.php?ip=$infoip><font color=silver face=verdana size=1>$infoip</b></a><br><br><br><b>Other used IP addresses:</font></b><br>";
                                                ...
                                                {$gansgtersfound = $findgangsterarray['username'];$ip = $findgangsterarray['ip'];
                                                    if($ip == '77.96.49.94'){
                                                        ...
                                                        if($ip == $infoip){
                                                            ...
                                                            echo"<a href=duperesults.php?ip=$ip><font color=silver face=verdana size=1><b>$ip</b></a></font><br>";
                                                        }
                                                    }
                                                }
                                            }
