                            ...
                            <div style="padding: 5px; margin: auto; text-align: center; color: #fefefe;">
                                <div style="margin: auto; padding-top: 16px; padding-bottom: 6px; text-align: center;">
                                    ...
                                    if (isset($_POST['do'])) {
                                        ...
                                        } elseif ($topicchecktwo > '10') {
                                            echo '<font color="white" face="verdana" size="1">You cannot have more than 10 topics on the forum at one time!</font>';
                                        } else {
...
VALUES ('$gangsterusername','1','$time','$crewid','$forumtopic','$forumtopicinfo','50','$topic_dte')");

                                            } else {


                                                mysql_query("INSERT INTO forumtopics(creator,id,time,type,title,info,rankid,dte)
VALUES ('$gangsterusername','1','$time','$crewid','$forumtopic','$forumtopicinfo','$myrank','$topic_dte')");
                                            }
                                    ...
                                    <table class="miniMenu miniMain forum" style="width: 81%; max-width: 950px;"
                                        ...
                                        $selectstickysql = mysql_query("SELECT * FROM forumtopics WHERE type = '$crewid' AND id = '2' ORDER BY time DESC LIMIT 0,50");
                                        ...
                                        while ($selectimportant = mysql_fetch_array($selectimportantsql)) {
                                            ...
                                            while ($all = mysql_fetch_array($while)) {
                                                $i = $i + 1;
                                                $zpattern[$i] = $all['word'];
                                                $zreplace[$i] = "<font color=red>*Word Blocked*</font>";
                                            }
                                            ...
                                            <? if ($i == 1) {
                                                ...
                                                <tr>
                                                    <td class="statsDiv"><a
                                                                href="crewviewtopic.php?topicid=<? echo $itopicid; ?>"
                                            ...
                                            <? } else {
                                                ...
                                                <tr>
                                                    <td class="statsDiv"><a
                                                                href="crewviewtopic.php?topicid=<? echo $itopicid; ?>"><span
                                        ...
                                        while ($selectsticky = mysql_fetch_array($selectstickysql)) {
                                            ...
                                            <tr>
                                                <td class="statsDiv"><a
                                                            href="crewviewtopic.php?topicid=<? echo $stopicid; ?>"><span
                                        ...
                                        while ($selecttopics = mysql_fetch_array($selecttopicssql)) {
                                            ...
                                            <tr>
                                                <td class="statsDiv"><a
                                                            href="crewviewtopic.php?topicid=<? echo $topicid; ?>"><? echo $title; ?><? if ($locked == 'yes') { ?>
                                                            <span style="color: #777777; padding-left: 3px;">(Locked)</span><? } ?>
                                                    </a></td>
                                                <td class="statsDiv"><a
