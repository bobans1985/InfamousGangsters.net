                            ...
                            <div style="padding: 5px; margin: auto; text-align: center; color: #fefefe;">
                                <div style="margin: auto; padding-top: 16px; padding-bottom: 6px; text-align: left;">
                                    ...
                                    if($_POST['submit']){
                                        ...
                                        for($i=3;$i <= $players;$i++){
                                            $value = $i;
                                            $array = arraymerge($array,$value);}
                                        shuffle($array);

                                        for($i=0;$i<$players;$i++){
                                            if($i+1 == $players){
                                                echo "<font size=1 color=white face=verdana>All other numbers have been rolled, that means <b>".$array[$i]."</b> is the winner!</font><br /><br />";
                                            }else{
                                                echo "<font size=1 color=white face=verdana>The dice rolled <b>".$array[$i]."</b>, that means <b>".$array[$i]."</b> is out!</font><br />"; }
                                        }
                                    }?>
