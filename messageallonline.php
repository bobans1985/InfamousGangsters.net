                        ...
                        <div class="main curve2px">
                            ...
                            <div style="padding: 5px; margin: auto; text-align: center; color: #fefefe;">
                                <div style="margin: auto; padding-top: 16px; padding-bottom: 6px; text-align: center;">
                                    ...
                                    if(isset($_POST['do'])) {
                                        if(!$sendinfo){}
                                        $selectallsql = mysql_query("SELECT * FROM usersonline");
...
VALUES ('$sendtoall','$gangsterusername','yes','$userip','$sendinfo')");}
                                        $showoutcome++; $outcome = "<font color=\"white\" face=\"verdana\" size=\"1\"><b>Message sent to all</b>!</font>";mysql_query("UPDATE users SET mail = (mail + 1) WHERE status = 'Alive'");}
                                    ?>
                                    ...
                                    <table align="center" width="85%" cellpadding="0" cellspacing="1" class="section">
                                        <br><center><form action="" method="post" name="smiley"><font color="white" face="verdana" size="1">Message:</font><br><textarea name="sendinfo" cols="42" rows="11" class="textarea"></textarea><br>
                                                <input type ="submit" value="Send message" class="textarea curve3px" name="do"></center>
                                        </form>
