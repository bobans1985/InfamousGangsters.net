    ...
    <tr>
        ...
        <td valign="top">
            ...
            <div style="margin-bottom: 9px; text-align: center;">
                ...
                <input type="submit" value="Next page" class="textarea curve3px inline_form" name="next"
                       style="padding-left: 9px; padding-right: 9px;">
            </div>
            <?php
            $getposts = mysql_query("SELECT * FROM messages WHERE sentfrom = '$usernameone' ORDER BY id DESC LIMIT $selectfrom,$selectto ");
            ...
            while ($getpostsarray = mysql_fetch_array($getposts)) {
                ...
                if (($new == 'yes') || ($colorid == 'yes')) {
                    ...
                    $color = "<font color=#CCC face=verdana size=1>$postname</font>";
                }
                ?>
                            ...
                            <td>
                                <div class="main">
                                    <div class="menuHeader noTop"
                                        ...
                                        Message sent to: <a href="viewprofile.php?username=<? echo $postname ?>"
                                                            style=""><? echo $color ?></a>
                                    </div>
