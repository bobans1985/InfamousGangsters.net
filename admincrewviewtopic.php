...
<table cellspacing="0" class="resize" id="block">
    <tr>
        ...
        <td valign="top" class="main">
            ...
            if($titdate == '0000-00-00 00:00:00'){$titdate = '<font color=silver face=verdana size=1>Time/Date: Not Available</font>';}
...
VALUES ('$gangsterusername','$topicid','$userip','$crewid','$newpost','$playerrank')");
            ...
            <script>
                function ajaxFunctionhis(){
                    ...
                    var strhehe = "<?echo$noposts;?>&admincrewtopicid=<?echo$topicid;?>&rand="+Math.random();
            ...
            <? $countposts = mysql_num_rows(mysql_query("SELECT * FROM forumposts WHERE topicid = '$topicid' AND type = '$crewid'"));
            ?>
                <form action = "admincrewviewtopic.php?topicid=<?echo$topicid;?>&crewid=<?echo$crewid;?>" method = "post" style="padding: 7px; text-align: center;">
                ...
                <tr>
                    ...
                    <input type ="submit" value="NORMAL" class=\'textarea inline_form curve3px\' name="undo">';
                            ...
                            <div style="margin: auto; max-width: 413px;">
                                <form action="admincrewviewtopic.php?topicid=<?echo$topicid;?>&crewid=<?echo$crewid;?>" method="post" name="smiley" style="text-align:center;">
