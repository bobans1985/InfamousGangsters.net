 ...
 <head>
     ...
     <script type="text/javascript">
         function topicEmotion(em) {
             //document.smiley.newpost.value = document.smiley.newpost.value + em;
 ...
 <table cellspacing="0" class="resize" id="block">
     <tr>
         ...
         <td valign="top" class="main">
             ...
             $posttits = mysql_num_rows(mysql_query("SELECT * FROM forumtopics WHERE topicid = '$topicid' AND type = '$crewid'"));
             ...
             $apattern[13] = "/\[s\](.*?)\[\/s\]/is";
             $apattern[14] = "/\[users\](.*?)\[\/users\]/is";
             $apattern[16] = "/\[user\](.*?)\[\/user\]/is";
             ...
             if(isset($_POST['dopost'])) {
                 ...
                 elseif($topiccheck == '0'){$showoutcome++; $outcome = '<font color=red face=verdana size=1><b>No such topic!</b></font><META HTTP-EQUIV="Refresh" CONTENT="2; URL=crewforum.php">';}
                 else{
...
VALUES ('$gangsterusername','$topicid','$userip','$post_time','$crewid','$newpost','$playerrank')");
             ...
             if(($rankid == '100')||($rankid == '75')||($rankid == '50')||($crewboss > '0')||($crewunderboss > '0')){
             ...
             if(($topiccreator == $gangsterusername)||($rankid == '100')||($rankid == '75')||($rankid == '50')||($crewboss > '0')||($crewunderboss > '0')){
                 if(isset($_GET['lock'])) { $showoutcome++; $outcome = '<font color=white face=verdana size=1>Topic locked</font>';mysql_query("UPDATE forumtopics SET locked = 'yes' WHERE topicid = '$topicid' AND type = '$crewid'");} }

             if(($rankid == '100')||($rankid == '75')||($rankid == '50')||($crewboss > '0')||($crewunderboss > '0')){
                 if(isset($_GET['unlock'])) {$showoutcome++; $outcome = '<font color=white face=verdana size=1>Topic Unlocked</font>';mysql_query("UPDATE forumtopics SET locked = 'no' WHERE topicid = '$topicid' AND type = '$crewid'");} }
             ...
             if($exists == '0'){$showoutcome++; $outcome = '<font color=red face=verdana size=1><b>No such topic!</b></font><META HTTP-EQUIV="Refresh" CONTENT="2; URL=crewforum.php">';}
             ...
             <script>
                 ...
                 function ajaxFunctionhis(){
                     ...
                     ajaxRequest.open("GET", "newpostcrew.php?crewid=<?echo$crewid;?>&posts=" + strhehe, true);
                             ...
                             <div style="display: table; width: 100%; padding: 9px; padding-top: 5px; padding-bottom: 5px;">
                                 ...
                                 <div style="display: table-cell; text-align: right;">
                                     ...
                                     if(($topiccreator == $gangsterusername)||($rankid >= '25')||($hdoperson > '0')){
                                         ...
                                         echo"<a href=crewviewtopic.php?topicid=$topicid&lock=1 style=color:$cu;><b> Lock </b></a>";}
                                     if(($rankid >= '25')||($ahdo > '0')){
                                         if($toplocked == 'yes'){$cu = 'white';}
                                         else{$cu='white';}
                                         echo"<span class=\"miniSep\"> - </span><a href=crewviewtopic.php?topicid=$topicid&unlock=1 style=color:$cu;><b>Unlock </b></a>";
                                     }?>
                                 </div>
             ...
             <div id=editee style="display:none;" name=edit>
                 <div style="margin: auto; max-width: 413px;">
                     <form action="crewviewtopic.php?topicid=<?echo$topicid;?>" method="post" name="smileys" style="text-align: center;">
             ...
             ?>
                 <form action = "crewviewtopic.php?topicid=<?echo$topicid;?>" method = "post" style="padding: 7px; text-align: center;">
             ...
             <?php
             $getposts = mysql_query("SELECT username,rankid,id,post,time FROM forumposts WHERE topicid = '$topicid' AND type = '$crewid' ORDER BY id DESC LIMIT $selectfrom,$selectto ");
             ...
             <table class="menuTable curve10px" cellspacing="0" cellpadding="0">
                 ...
                 <tr>
                    ...
                    <input type ="submit" value="NORMAL" class=\'textarea inline_form curve3px\' name="undo">';
                             ...
                             <div style="margin: auto; max-width: 413px;">
                                 <form action="crewviewtopic.php?topicid=<?echo$topicid;?>" method="post" name="smiley" style="text-align:center;">
                         ...
                         <div class="crewFeed" style="position: relative;">
                             <div class="menuHeader noTop"
                                 ...
                                 Crew Feed <span
                                     ...
                                     <span class="membersOnline twinkle" style="position: relative; top: -0.75px;">•</span></span>
                                 <?
